# RAG-03 — UI/UX (Tailwind + SCSS) pour corbidev-auth

## Principes

- Simplicité et cohérence: Tailwind comme base utilitaire; SCSS pour variables/mixins/overrides.
- Accessibilité (a11y): labels/form inputs lisibles, focus states visibles, contrastes élevés.
...
- Auth pages: Login, Registration, Email Verification, Forgot/Reset, Profil.
- Composants communs: Header minimal, Footer, Alert/Toast, Form inputs, Buttons.
- États: chargement, erreurs, validations côté client (basique), messages explicites.

## Styles & Thèmes

- Palette: neutres/gris pour fond; accent principal pour éléments interactifs.
- Tailwind config: breakpoints, spacing, radius; daisyUI/Flowbite si besoin rapide.

## Contenu & Consentement

- CGU/Privacy: page dédiée, modale d'acceptation à l'inscription; journaliser version + timestamp.

## Performance

- Purge/optimize Tailwind; assets versionnés; cache proxy.
- Préférer CSS utilitaire, limiter SCSS complexes; éviter JS lourd inutile.
