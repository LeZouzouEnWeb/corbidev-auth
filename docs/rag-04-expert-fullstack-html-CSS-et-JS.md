# RAG-04 — Fullstack (HTML/CSS/JS) pour corbidev-auth
...
- CSS: Tailwind CSS (principal) + SCSS (overrides ciblés).
- JS: vanilla léger pour interactions basiques (toggle mot de passe, validations simples, modales).
- Build: AssetMapper (Symfony 7) sans bundler; passer à Encore si besoins avancés.
